...
if(sessionFactory == null) { //ilk defa oluşuyorsa buraya gelir
			...
			//Aşağıdakiler yapcağım configuration nasıl olsun kısmı settings 
			//diyoruz oralar ayarlamalar en sonda da setProperties diyerek ayarlıyoruz.
			...
			settings.put(Environment.PASS, "asd123asd");
			...
			settings.put(Environment.SHOW_SQL, "false"); //Hibernate üzerinden VT'ye giden SQL komutlarını görmemize yarar, false yaparsak göremeyiz.
			settings.put(Environment.FORMAT_SQL, "false"); //Hibernate üzerinden VT'ye giden SQL komutlarının bizlerin anlayacağı basitlikte düzenler.
