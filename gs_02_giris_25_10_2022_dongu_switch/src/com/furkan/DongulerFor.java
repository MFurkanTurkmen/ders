...
public class DongulerFor {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("Merhaba"); System.out.println("Merhaba");
		 * System.out.println("Merhaba"); System.out.println("Merhaba");
		 ...
		 * Sonsuz döngü için
		 * 
		 * for(;;) { System.out.println("Sonsuz"); System.out.println("Döngü"); }
		 * 
		 */
		...
		// yaşam konteksi (scope'u diyebiliriz. for loop'unun içindeyse eğer k mesela
		// işler.
	}
