...
public class Switch {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out.println("Lütfen işlem giriniz: "); int key = scanner.nextInt();
		 * 
		 * if (key==1) { System.out.println("toplama"); } else if (key==2) {
		 * System.out.println("çıkarma"); } else if (key==3) {
		 * System.out.println("çarpma"); } else if (key==4) {
		...
		/*
		 * switch (key) { case value1: //işlem1 break; case value2: //işlem2 break; ...
		 * default: break; }
		 */
		// scanner yukarıda
